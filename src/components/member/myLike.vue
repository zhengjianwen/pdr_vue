<template>
    <div class="myLike">
        <headerNav titles="我的喜欢" show="true"></headerNav>
        <div class="content">
            <ul>
                <li>
                    <div class="top">
                        <div class="left">
                            ...
                            <dl>
                                <dd>评价褒贬不一，iPhone X到底怎么样？</dd>
                                <dt>办公室游戏兼得，高性价比游戏本自大号的办公室游戏兼得，高性价比游戏本大号的不信心谁谁谁谁谁谁谁谁谁谁谁谁</dt>
                            </dl>
                        </div>
...
.rightbo span:nth-child(1),.icon-heart2 {
